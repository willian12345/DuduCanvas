...
export default abstract class Graphics {
    ...
    graphics: {
        ...
        fillRoundRect: (x: number, y: number, w: number, h: number, radius: number | number[], fill?: boolean, stroke?: boolean) => any;
        strokeRoundRect: (x: number, y: number, w: number, h: number, radius: number | number[]) => any;
        /**
